...
const commands = {
    ...
    "/b": async (ctx, mention) => {
        ...
        await sendMessage(ctx, `(команда /b)\n🗣 ${mention}, одна из цитат:\n\n<b>${quote}</b> \n\n<i>-Конфуций</i>`);
    },
};
